...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <asp:SqlDataSource ID="DSAddress" runat="server" ConnectionString="<%$ ConnectionStrings:LoginConnectionString %>" SelectCommand="SELECT streetAddress, suburb, postCode FROM Customer WHERE (customerID = @CusID)" UpdateCommand="UPDATE Customer SET streetAddress = @streetAddress, suburb = @suburb, postCode = @postCode WHERE (customerID = @CusID)">
                <SelectParameters>
