            ...
            <asp:Panel ID="pnlStats" runat="server" CssClass="sale-stats" Visible="false">
                <div class="sale-stat">
                    <div class="sale-stat-body">
                        <span class="sale-stat-value">
                            <asp:Label ID="lblStatOrders" runat="server" Text="0" /></span>
                ...
                <div class="sale-stat">
                    <div class="sale-stat-body">
                        <span class="sale-stat-value">
                            <asp:Label ID="lblStatSpent" runat="server" Text="R0.00" /></span>
                ...
                <div class="sale-stat">
                    <div class="sale-stat-body">
                        <span class="sale-stat-value">
                            <asp:Label ID="lblStatLatest" runat="server" Text="—" /></span>
        ...
        <asp:Panel ID="pnlSaleDetail" runat="server" Visible="false" CssClass="order-detail">
            ...
            <div class="order-detail-meta">
                ...
                <div class="odm-item">
                    ...
                    <span class="odm-v">
                        <asp:Label ID="lblSelectedPayment" runat="server" />
                    </span>
                </div>
                <div class="odm-item">
                    <span class="odm-k">Items</span>
                    <span class="odm-v">
                        <asp:Label ID="lblSelectedCount" runat="server" />
                    </span>
                </div>
            </div>
