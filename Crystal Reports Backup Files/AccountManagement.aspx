        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    <asp:Label runat="server" AssociatedControlID="FirstName" CssClass="form-label">First Name</asp:Label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    <asp:Label runat="server" AssociatedControlID="txtStreet" CssClass="form-label">Street Address</asp:Label>
                    <asp:TextBox ID="txtStreet" runat="server" CssClass="form-control"></asp:TextBox>
                </div>

                <div class="form-group mb-3">
                    <asp:Label runat="server" AssociatedControlID="txtSuburb" CssClass="form-label">Suburb</asp:Label>
                    <asp:TextBox ID="txtSuburb" runat="server" CssClass="form-control"></asp:TextBox>
                </div>

                <div class="form-group mb-3">
                    <asp:Label runat="server" AssociatedControlID="txtPost" CssClass="form-label">Postal Code</asp:Label>
                    <asp:TextBox ID="txtPost" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
        </div>
    </div>
