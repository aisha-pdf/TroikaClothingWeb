...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .item-name { color: var(--troika-navy); font-weight:600; font-size:16px; }
        ...
        .btn-ghost:hover { background: var(--troika-light-accent); color: var(--troika-white); }
        ...
        .checkout-center { text-align:center; margin-top:18px; }
        ...
        @media(max-width:900px){
            .panel-bottom { flex-direction: column; align-items:stretch; gap:10px; }
            .grid { gap:16px; }
        }
    </style>
</asp:Content>
      ...
      <asp:PlaceHolder ID="phCart" runat="server">
        <div class="grid">
          ...
          <div class="panel">
            ...
            <div class="muted" style="margin-bottom:6px;">Delivery: <asp:Label ID="lblDelivery" runat="server" /></div>
            <div class="total">Total: R<asp:Label ID="lblTotal" runat="server" /></div>
            <div class="muted" style="margin-bottom:10px;">Estimated Delivery: <asp:Label ID="lblEstDelivery" runat="server" /></div>
