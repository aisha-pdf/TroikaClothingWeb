...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: #fff; padding: 40px; max-width: 1100px; margin: 40px auto; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        ...
        <!-- About Us Section -->
        <h1 style="text-align: center; color: #2c3e50;">About Us</h1>
        ...
        <!-- Our Story -->
        <h2 style="text-align: center; color: #2c3e50;">Our Story</h2>
        <p style="font-size: 18px; color: #555; text-align: justify;">
        ...
        <!-- Vision & Mission -->
        <h2 style="text-align: center; margin-top: 50px; color: #2c3e50;">Our Vision & Mission</h2>
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px; margin-top: 30px;">

            <div style="flex: 1; min-width: 300px; background: #f8f9fa; padding: 25px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);">
                <h3 style="color: #2c3e50; text-align: center;">Vision</h3>
            ...
            <div style="flex: 1; min-width: 300px; background: #f8f9fa; padding: 25px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);">
                <h3 style="color: #2c3e50; text-align: center;">Mission</h3>
                <p style="font-size: 16px; color: #555; text-align: center;">
        ...
        <!-- Why Choose Us -->
        <h2 style="margin-top: 50px; color: #2c3e50;">Why Choose Us?</h2>
        <ul style="font-size: 18px; color: #555; line-height: 1.8;">
        ...
        <!-- Core Values -->
        <h2 style="margin-top: 50px; color: #2c3e50;">Our Core Values</h2>
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px; margin-top: 20px;">
            <div style="flex: 1; min-width: 200px; background: #eef6ff; padding: 20px; border-radius: 10px; text-align: center;">
                <h3 style="color: #2c3e50;">Excellence</h3>
                <p style="color: #555;">We strive for perfection in every garment, from design to delivery.</p>
            </div>
            <div style="flex: 1; min-width: 200px; background: #eef6ff; padding: 20px; border-radius: 10px; text-align: center;">
                <h3 style="color: #2c3e50;">Integrity</h3>
                <p style="color: #555;">We uphold fairness, transparency, and trust in every partnership and purchase.</p>
            </div>
            <div style="flex: 1; min-width: 200px; background: #eef6ff; padding: 20px; border-radius: 10px; text-align: center;">
                <h3 style="color: #2c3e50;">Innovation</h3>
                <p style="color: #555;">We evolve with the fashion world, balancing modern design with timeless craftsmanship.</p>
            </div>
        </div>
    </div>
</asp:Content>
