...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex; min-height: 80vh;">
        ...
        <div style="flex: 1; background: #f4f4f4; padding: 30px;">
            <h2 style="color: #3D304C; margin-bottom: 20px;">USER MANAGEMENT - PROFILE</h2>
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="646px" AutoGenerateRows="False" CellPadding="4" DataKeyNames="ID" DataSourceID="AdminProfileDS" ForeColor="#333333" GridLines="None">
